 ...
 * @author `Dipanker
 */
public class ShowFSalesCenterController implements Initializable {
    ...
    private void viewButtonOnAction(ActionEvent event) {
        ...
        try {
            ...
            if(!f.exists()){
                show.setText("Oops! FertilizerSalesCenter.bin binary file does not exist...");
            }
            else{
                ...
                //String str="";
                while(true){
                    str+= "Fertilizer Name:"+dis.readUTF()
                        +"; Fertilzer Warehouse Name:"+dis.readUTF()
                            +"; Division:"+dis.readUTF()
                            +"; Distric:"+dis.readUTF()
                            +"; Upazila:"+dis.readUTF()
                            +"; Location:"+dis.readUTF()
                        +"; Phn Number:"+Integer.toString(dis.readInt())
